...
- Current development version: **0.9.2.81**
...
- Current: 0.9.2.81 — Single-tree revalidation + GUI test plugin path
- Last completed Windows build/test line: **0.9.2.81**
- Last completed v0.9.2.81 build: Core + GUI Release build PASS
- Last completed v0.9.2.81 test run: **CTest 56/56 PASS**
- Last completed v0.9.2.81 validation: --version 0.9.2.81 and --smoke exit 0
...
See docs/build-history/0.9.2.81.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
