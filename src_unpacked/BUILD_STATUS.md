...
- Current development version: **0.9.3.9**
...
- Current: 0.9.3.9 — Search freshness, video fingerprint, benchmark, and monitor hardening
- Last completed Windows build/test line: **0.9.3.9**
- Last completed v0.9.3.9 build: Core + GUI Release build PASS
- Last completed v0.9.3.9 test run: **CTest 59/59 PASS**
- Last completed v0.9.3.9 validation: --smoke exit 0
...
See docs/build-history/0.9.3.9.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
