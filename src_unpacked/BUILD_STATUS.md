...
- Current development version: **0.9.4.1**
...
- Current: 0.9.4.1 — MainWindow scan-workflow regression test (engine 1.5.0, video cache v9)
- Last completed Windows build/test line: **0.9.4.1**
- Last completed v0.9.4.1 build: Core + GUI Release build PASS (CPU and GPU trees)
...
See docs/build-history/0.9.4.1.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
