...
- Current development version: **0.9.2.71**
...
- Current: 0.9.2.71 — Engine version stamp + stored-match revalidation
- Last completed Windows build/test line: **0.9.2.71**
- Last completed v0.9.2.71 build: Core + GUI Release build PASS
- Last completed v0.9.2.71 test run: **CTest 54/54 PASS**
- Last completed v0.9.2.71 validation: --version 0.9.2.71 and --smoke exit 0
...
See docs/build-history/0.9.2.71.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
