...
- Current development version: **0.9.2.66**
...
- Current: 0.9.2.66 — E2E video regression + EXIF rotation + cleanups
- Last completed Windows build/test line: **0.9.2.66**
- Last completed v0.9.2.66 build: Core + GUI Release build PASS
- Last completed v0.9.2.66 test run: **CTest 50/50 PASS**
- Last completed v0.9.2.66 validation: --version 0.9.2.66 and --smoke exit 0
...
See docs/build-history/0.9.2.66.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
