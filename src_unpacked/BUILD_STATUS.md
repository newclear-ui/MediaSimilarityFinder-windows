...
- Current development version: **0.9.2.80**
...
- Current: 0.9.2.80 — Reference tie-break (similarity first, then resolution/size)
- Last completed Windows build/test line: **0.9.2.80**
- Last completed v0.9.2.80 build: Core + GUI Release build PASS
- Last completed v0.9.2.80 test run: **CTest 56/56 PASS**
- Last completed v0.9.2.80 validation: --version 0.9.2.80 and --smoke exit 0
...
See docs/build-history/0.9.2.80.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
