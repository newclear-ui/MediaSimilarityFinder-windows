...
- Last completed v0.9.2.64 validation: --version 0.9.2.64 and --smoke exit 0
...
See docs/build-history/0.9.2.64.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
