...
- Current development version: **0.9.3.16**
...
- Current: 0.9.3.16 — Crop-only verdict split, stop responsiveness, color previews (engine 1.4.0)
- Last completed Windows build/test line: **0.9.3.16**
- Last completed v0.9.3.16 build: Core + GUI Release build PASS
- Last completed v0.9.3.16 test run: **CTest 62/62 PASS**
- Last completed v0.9.3.16 validation: reported video pair rejected; stop popup immediate; Portable v0.9.3.16 smoke exit 0; `--version` 0.9.3.16
...
See docs/build-history/0.9.3.16.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
