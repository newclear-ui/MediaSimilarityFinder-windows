...
- Current development version: **0.9.3.7**
...
- Current: 0.9.3.7 — Engine lookup before budget gate + video unit fix
- Last completed Windows build/test line: **0.9.3.7**
- Last completed v0.9.3.7 build: Core + GUI Release build PASS
- Last completed v0.9.3.7 test run: **CTest 59/59 PASS**
- Last completed v0.9.3.7 validation: --version 0.9.3.7 and --smoke exit 0
...
See docs/build-history/0.9.3.7.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
