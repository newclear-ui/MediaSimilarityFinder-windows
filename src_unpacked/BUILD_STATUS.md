...
- Current development version: **0.9.2.85**
...
- Current: 0.9.2.85 — Self-check path bug fix (GetModuleFileNameW)
- Last completed Windows build/test line: **0.9.2.85**
- Last completed v0.9.2.85 build: Core + GUI Release build PASS
- Last completed v0.9.2.85 test run: **CTest 56/56 PASS**
- Last completed v0.9.2.85 validation: --version 0.9.2.85 and --smoke exit 0
...
See docs/build-history/0.9.2.85.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
