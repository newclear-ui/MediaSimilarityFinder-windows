...
- Current development version: **0.9.2.87**
...
- Current: 0.9.2.87 — CUDA kernel 1e-7 snap (CPU/GPU flat-image agreement)
- Last completed Windows build/test line: **0.9.2.87**
- Last completed v0.9.2.87 build: Core + GUI Release build PASS
- Last completed v0.9.2.87 test run: **CTest 57/57 PASS**
- Last completed v0.9.2.87 validation: --version 0.9.2.87 and --smoke exit 0
...
See docs/build-history/0.9.2.87.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
