...
- Current development version: **0.9.2.84**
...
- Current: 0.9.2.84 — Build output runs out of the box (in-build Qt plugin deploy)
- Last completed Windows build/test line: **0.9.2.84**
- Last completed v0.9.2.84 build: Core + GUI Release build PASS
- Last completed v0.9.2.84 test run: **CTest 56/56 PASS**
- Last completed v0.9.2.84 validation: --version 0.9.2.84 and --smoke exit 0
...
See docs/build-history/0.9.2.84.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
