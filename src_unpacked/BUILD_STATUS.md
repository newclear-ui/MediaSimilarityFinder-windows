...
- Current: 0.9.2.89 — Right-click selection (reveal misfire fix)
- Last completed Windows build/test line: **0.9.2.89**
- Last completed v0.9.2.89 build: Core + GUI Release build PASS
- Last completed v0.9.2.89 test run: **CTest 58/58 PASS**
- Last completed v0.9.2.89 validation: --version 0.9.2.89 and --smoke exit 0
...
See docs/build-history/0.9.2.89.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
