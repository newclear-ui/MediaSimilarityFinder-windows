...
- Current development version: **0.9.2.72**
...
- Current: 0.9.2.72 — Engine/DB version split (semver)
- Last completed Windows build/test line: **0.9.2.72**
- Last completed v0.9.2.72 build: Core + GUI Release build PASS
- Last completed v0.9.2.72 test run: **CTest 54/54 PASS**
- Last completed v0.9.2.72 validation: --version 0.9.2.72 and --smoke exit 0
...
See docs/build-history/0.9.2.72.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
