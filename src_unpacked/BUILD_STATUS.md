...
- Current development version: **0.9.3.4**
...
- Current: 0.9.3.4 — Always-on benchmark log, log button, scroll fix
- Last completed Windows build/test line: **0.9.3.4**
- Last completed v0.9.3.4 build: Core + GUI Release build PASS
- Last completed v0.9.3.4 test run: **CTest 59/59 PASS**
- Last completed v0.9.3.4 validation: --version 0.9.3.4 and --smoke exit 0
...
See docs/build-history/0.9.3.4.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
