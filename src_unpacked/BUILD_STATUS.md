...
- Current development version: **0.9.4.7**
...
- Current: 0.9.4.7 — Node B6 Resource Mode Integration (engine 1.5.0, video cache v9)
- Active Node B substep: B6 (B7 not started)
- Last completed Windows build/test line: **0.9.4.7**
- Last completed v0.9.4.7 build: Core + GUI Release build PASS (CPU and GPU trees)
- Last completed v0.9.4.7 test run: **CTest 65/65 PASS (GPU)**
- Last completed v0.9.4.7 validation: B6 scheduler_test additions PASS on both trees (mode table, mode divergence, asymmetric relief, per-mode holds, Manual == Balanced); `--version` 0.9.4.7
