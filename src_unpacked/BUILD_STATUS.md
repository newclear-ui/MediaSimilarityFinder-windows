...
- Current development version: **0.9.3.19**
...
- Current: 0.9.3.19 — PDH disk counter fix, integrated prompt review (engine 1.5.0, video cache v9)
- Last completed Windows build/test line: **0.9.3.19**
- Last completed v0.9.3.19 build: Core + GUI Release build PASS
- Last completed v0.9.3.19 test run: **CTest 63/63 PASS**
- Last completed v0.9.3.19 validation: PDH first-collect tolerant; prompt doc current; Portable v0.9.3.19 smoke exit 0; `--version` 0.9.3.19
...
See docs/build-history/0.9.3.19.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
