...
- Current development version: **0.9.3.8**
...
- Current: 0.9.3.8 — Thumbnail catch-up scheduler after scan completion
- Last completed Windows build/test line: **0.9.3.8**
- Last completed v0.9.3.8 build: Core + GUI Release build PASS
- Last completed v0.9.3.8 test run: **CTest 59/59 PASS**
- Last completed v0.9.3.8 validation: --smoke exit 0
...
See docs/build-history/0.9.3.8.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
