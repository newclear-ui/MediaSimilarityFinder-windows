...
- Current development version: **0.9.2.70**
...
- Current: 0.9.2.70 — Image false-positive second-stage gate
- Last completed Windows build/test line: **0.9.2.70**
- Last completed v0.9.2.70 build: Core + GUI Release build PASS
- Last completed v0.9.2.70 test run: **CTest 53/53 PASS**
- Last completed v0.9.2.70 validation: --version 0.9.2.70 and --smoke exit 0
...
See docs/build-history/0.9.2.70.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
