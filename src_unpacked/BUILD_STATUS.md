...
- Current development version: **0.9.3.10**
...
- Current: 0.9.3.10 — Group-list scroll anchor restoration
...
- Last completed v0.9.3.10 validation: --smoke exit 0
...
See docs/build-history/0.9.3.10.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
