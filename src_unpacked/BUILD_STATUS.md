...
- Current development version: **0.9.2.74**
...
- Current: 0.9.2.74 — Monitor toolbar cleanup (pause removed, toggle highlight, menu right)
- Last completed Windows build/test line: **0.9.2.74**
- Last completed v0.9.2.74 build: Core + GUI Release build PASS
- Last completed v0.9.2.74 test run: **CTest 54/54 PASS**
- Last completed v0.9.2.74 validation: --version 0.9.2.74 and --smoke exit 0
...
See docs/build-history/0.9.2.74.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
