...
- Current development version: **0.9.2.79**
...
- Current: 0.9.2.79 — Explorer window reuse + GPU accelerating/stopped/idle states
- Last completed Windows build/test line: **0.9.2.79**
- Last completed v0.9.2.79 build: Core + GUI Release build PASS
- Last completed v0.9.2.79 test run: **CTest 55/55 PASS**
- Last completed v0.9.2.79 validation: --version 0.9.2.79 and --smoke exit 0
...
See docs/build-history/0.9.2.79.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
