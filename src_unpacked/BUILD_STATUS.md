...
- Current development version: **0.9.2.77**
...
- Current: 0.9.2.77 — Button style unification + detail/grid intrusion fixes
- Last completed Windows build/test line: **0.9.2.77**
- Last completed v0.9.2.77 build: Core + GUI Release build PASS
- Last completed v0.9.2.77 test run: **CTest 55/55 PASS**
- Last completed v0.9.2.77 validation: --version 0.9.2.77 and --smoke exit 0
...
See docs/build-history/0.9.2.77.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
