...
- Current development version: **0.9.3.18**
...
- Current: 0.9.3.18 — Benchmark disk I/O, duration direct fallback, popup readability (engine 1.5.0, video cache v9)
- Last completed Windows build/test line: **0.9.3.18**
- Last completed v0.9.3.18 build: Core + GUI Release build PASS
- Last completed v0.9.3.18 test run: **CTest 63/63 PASS**
- Last completed v0.9.3.18 validation: PDH disk counters live; trStr audit clean; Portable v0.9.3.18 smoke exit 0; `--version` 0.9.3.18
...
See docs/build-history/0.9.3.18.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
