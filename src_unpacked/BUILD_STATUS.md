...
- Last completed v0.9.2.63 build: Core + GUI Release build PASS
- Last completed v0.9.2.63 test run: **CTest 49/49 PASS**
- Last completed v0.9.2.63 validation: thumb_cache_test included; --version 0.9.2.63 and --smoke exit 0
