...
- Current development version: **0.9.2.86**
...
- Current: 0.9.2.86 — Fast pHash, reveal fallback, ffprobe DLLs
- Last completed Windows build/test line: **0.9.2.86**
- Last completed v0.9.2.86 build: Core + GUI Release build PASS
- Last completed v0.9.2.86 test run: **CTest 57/57 PASS**
- Last completed v0.9.2.86 validation: --version 0.9.2.86 and --smoke exit 0
...
See docs/build-history/0.9.2.86.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
