...
- Current development version: **0.9.2.90**
...
- Current: 0.9.2.90 — External report follow-ups (sampling, verify, index, 2nd stage)
- Last completed Windows build/test line: **0.9.2.90**
- Last completed v0.9.2.90 build: Core + GUI Release build PASS
- Last completed v0.9.2.90 test run: **CTest 58/58 PASS**
- Last completed v0.9.2.90 validation: --version 0.9.2.90 and --smoke exit 0
...
See docs/build-history/0.9.2.90.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
