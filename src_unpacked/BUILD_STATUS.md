...
- Current development version: **0.9.3.13**
...
- Current: 0.9.3.13 — Video pHash CUDA batch acceleration
- Last completed Windows build/test line: **0.9.3.13**
...
See docs/build-history/0.9.3.13.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
