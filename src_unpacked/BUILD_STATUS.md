...
- Current development version: **0.9.3.17**
...
- Current: 0.9.3.17 — Single-sweep video decode, duration fallback (engine 1.5.0, video cache v9)
- Last completed Windows build/test line: **0.9.3.17**
- Last completed v0.9.3.17 build: Core + GUI Release build PASS
- Last completed v0.9.3.17 test run: **CTest 63/63 PASS**
- Last completed v0.9.3.17 validation: slowest-file sweep halved by construction; parity test PASS; Portable v0.9.3.17 smoke exit 0; `--version` 0.9.3.17
...
See docs/build-history/0.9.3.17.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
