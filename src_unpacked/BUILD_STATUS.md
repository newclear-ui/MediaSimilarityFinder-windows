...
- Current development version: **0.9.2.73**
...
- Current: 0.9.2.73 — Accepted audit items (SSIM gate, QuickLook, docs)
- Last completed Windows build/test line: **0.9.2.73**
- Last completed v0.9.2.73 build: Core + GUI Release build PASS
- Last completed v0.9.2.73 test run: **CTest 54/54 PASS**
- Last completed v0.9.2.73 validation: --version 0.9.2.73 and --smoke exit 0
...
See docs/build-history/0.9.2.73.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
