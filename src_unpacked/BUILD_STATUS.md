...
- Current development version: **0.9.2.75**
...
- Current: 0.9.2.75 — Toolbar, detail, and summary UI round
- Last completed Windows build/test line: **0.9.2.75**
- Last completed v0.9.2.75 build: Core + GUI Release build PASS
- Last completed v0.9.2.75 test run: **CTest 54/54 PASS**
- Last completed v0.9.2.75 validation: --version 0.9.2.75 and --smoke exit 0
...
See docs/build-history/0.9.2.75.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
