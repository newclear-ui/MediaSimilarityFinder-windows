...
- Current development version: **0.9.2.82**
...
- Current: 0.9.2.82 — Portable launch fix (plugin layout + bundled CRT)
- Last completed Windows build/test line: **0.9.2.82**
- Last completed v0.9.2.82 build: Core + GUI Release build PASS
- Last completed v0.9.2.82 test run: **CTest 56/56 PASS**
- Last completed v0.9.2.82 validation: --version 0.9.2.82 and --smoke exit 0
...
See docs/build-history/0.9.2.82.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
