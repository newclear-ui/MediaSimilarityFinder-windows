...
- Current development version: **0.9.2.83**
...
- Current: 0.9.2.83 — Startup self-check (platform plugin pre-flight)
- Last completed Windows build/test line: **0.9.2.83**
- Last completed v0.9.2.83 build: Core + GUI Release build PASS
- Last completed v0.9.2.83 test run: **CTest 56/56 PASS**
- Last completed v0.9.2.83 validation: --version 0.9.2.83 and --smoke exit 0
...
See docs/build-history/0.9.2.83.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
