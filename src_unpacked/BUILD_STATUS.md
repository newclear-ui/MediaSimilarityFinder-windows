...
- Current development version: **0.9.3.12**
...
- Current: 0.9.3.12 — Explorer reuse, cache/API freshness, group identity, and benchmark failure counters
- Last completed Windows build/test line: **0.9.3.12**
- Last completed v0.9.3.12 build: Core + GUI Release build PASS
- Last completed v0.9.3.12 test run: **CTest 59/59 PASS**
- Last completed v0.9.3.12 validation: extracted Portable `--smoke` exit 0; `reveal_window_test` PASS
...
See docs/build-history/0.9.3.12.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
