...
- Current development version: **0.9.3.2**
...
- Current: 0.9.3.2 — Benchmark toggle (temporary, remove in 1.0)
- Last completed Windows build/test line: **0.9.3.2**
- Last completed v0.9.3.2 build: Core + GUI Release build PASS
- Last completed v0.9.3.2 test run: **CTest 59/59 PASS**
- Last completed v0.9.3.2 validation: --version 0.9.3.2 and --smoke exit 0
...
See docs/build-history/0.9.3.2.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
