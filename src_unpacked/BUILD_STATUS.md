...
- Current development version: **0.9.2.67**
...
- Current: 0.9.2.67 — L3 SSIM verification cells + thumb48 cache v5
- Last completed Windows build/test line: **0.9.2.67**
- Last completed v0.9.2.67 build: Core + GUI Release build PASS
- Last completed v0.9.2.67 test run: **CTest 51/51 PASS**
- Last completed v0.9.2.67 validation: --version 0.9.2.67 and --smoke exit 0
...
See docs/build-history/0.9.2.67.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
