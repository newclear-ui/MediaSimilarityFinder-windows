...
- Current development version: **0.9.2.76**
...
- Current: 0.9.2.76 — Console-flash removal + spawn-free resolutions
- Last completed Windows build/test line: **0.9.2.76**
- Last completed v0.9.2.76 build: Core + GUI Release build PASS
- Last completed v0.9.2.76 test run: **CTest 55/55 PASS**
- Last completed v0.9.2.76 validation: --version 0.9.2.76 and --smoke exit 0
...
See docs/build-history/0.9.2.76.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
