...
- Current development version: **0.9.2.69**
...
- Current: 0.9.2.69 — Toolbar cleanup + live intermediate results + summary/count fixes
- Last completed Windows build/test line: **0.9.2.69**
- Last completed v0.9.2.69 build: Core + GUI Release build PASS
- Last completed v0.9.2.69 test run: **CTest 52/52 PASS**
- Last completed v0.9.2.69 validation: --version 0.9.2.69 and --smoke exit 0
...
See docs/build-history/0.9.2.69.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
