...
- Current development version: **0.9.2.88**
...
- Current: 0.9.2.88 — Reveal root fix (CLSCTX_ALL)
- Last completed Windows build/test line: **0.9.2.88**
- Last completed v0.9.2.88 build: Core + GUI Release build PASS
- Last completed v0.9.2.88 test run: **CTest 58/58 PASS**
- Last completed v0.9.2.88 validation: --version 0.9.2.88 and --smoke exit 0
...
See docs/build-history/0.9.2.88.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
