...
- Current development version: **0.9.3.3**
...
- Current: 0.9.3.3 — Progressive group thumbnails
- Last completed Windows build/test line: **0.9.3.3**
- Last completed v0.9.3.3 build: Core + GUI Release build PASS
- Last completed v0.9.3.3 test run: **CTest 59/59 PASS**
- Last completed v0.9.3.3 validation: --version 0.9.3.3 and --smoke exit 0
...
See docs/build-history/0.9.3.3.ko.md and .en.md for the current development changes. Official baseline: docs/build-history/0.9.2.32.ko.md and .en.md.
