...
## 현재 개발 버전: 0.9.4.8 (엔진 1.5.0, DB 1.0.3, 공식 기준선 0.9.2.32, 개발선 0.9.4 Node B 게이트 통과)
...
빌드 기록은 docs/build-history/에 한글/영문으로 관리(CTest GPU 65개 / CPU 64개). 아키텍처 문서는 docs/architecture/ 참조.
